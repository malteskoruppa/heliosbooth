...
ElGamal.PublicKey = function(p,q,g,y){
  ...
  this.verifyKnowledgeOfSecretKey = function(proof, challenge_generator) {
  ...
  this.verifyDecryptionFactor = function(ciphertext, decryption_factor, decryption_proof, challenge_generator) {
...
ElGamal.SecretKey = function(x, pk){
  ...
  this.decryptionFactor = function(ciphertext) {
    var decryption_factor = ciphertext.alpha.modPow(this.x, this.pk.p);
    return decryption_factor;
  };
  
  this.decrypt = function(ciphertext, decryption_factor) {
  ...
  this.decryptAndProve = function(ciphertext, challenge_generator) {
  ...
  this.decryptionFactorAndProof = function(ciphertext, challenge_generator) {
  ...
  this.proveKnowledge = function(challenge_generator) {
    // generate random w
...
ElGamal.Ciphertext = function(alpha, beta, pk){
  ...
  this.decrypt = function(list_of_dec_factors) {
  ...
  this.generateProof = function(plaintext, randomness, challenge_generator) {
  ...
  this.simulateProof = function(plaintext, challenge) {
  ...
  this.verifyProof = function(plaintext, proof, challenge_generator) {
  ...
  this.verifyDecryptionProof = function(plaintext, proof, challenge_generator) {
    // DH tuple to verify is 
    // g, alpha, y, beta/m
  ...
  this.generateDisjunctiveProof = function(list_of_plaintexts, real_index, randomness, challenge_generator) {
  ...
  this.verifyDisjunctiveProof = function(list_of_plaintexts, disj_proof, challenge_generator) {
    var result = true;
...
ElGamal.Proof = function(A, B, challenge, response){
  ...
  this.verify = function(little_g, little_h, big_g, big_h, p, q, challenge_generator) {
