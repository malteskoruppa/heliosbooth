...
UTILS.PROGRESS = function(){
  ...
  this.addTicks = function(n_ticks) {
...
HELIOS.Election = function(){
  ...
  // Note: "constructor" (init function) usually moved to the end, but here there is none
};
...
// Note: mimick _.extend
function underscore_extend(obj1, obj2){
    for(var key in obj2)
...
HELIOS.EncryptedAnswer = function(question, answer, pk, progress){
  ...
  this.doEncryption = function(question, answer, pk, randomness, progress) {
    var choices = [];
  ...
  this.toJSONObject = function(include_plaintext) {
    var return_obj = {
...
HELIOS.EncryptedVote = function(election, answers, progress){
  ...
  this.verifyEncryption = function(questions, pk) {
  ...
  this.get_audit_trail = function() {
    return this.toJSONObject(true);
  };
  
  this.verifyProofs = function(pk, outcome_callback) {
